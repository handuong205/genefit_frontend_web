...
export const toPlanRequest = (
  ...
  return {
    ...
    maxAiScansPerDay: source.maxAiScansPerDay ?? DEFAULT_FORM_VALUES.maxAiScansPerDay,
    maxHistoryViewDays: source.maxHistoryViewDays ?? DEFAULT_FORM_VALUES.maxHistoryViewDays,
